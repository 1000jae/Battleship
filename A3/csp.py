...
class CSP:
    ...
    def __init__(self, name, variables, constraints, ship_constraint):
        '''create a CSP problem object passing it a name, a list of
           variable objects, and a list of constraint objects'''
        self._name = name
        self._variables = variables
        self._constraints = constraints
        # constraint for ship count
        self._ship_count_constraint = ship_constraint
    ...
    def ship_count_constraint(self):
        """return ship count constraint"""
        return self._ship_count_constraint
